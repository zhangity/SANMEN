...
public class Service1Locator extends org.apache.axis.client.Service implements org.tempuri.Service1 {
    ...
    private java.lang.String Service1Soap12_address = "http://10.10.1.80:4321/Service1.asmx";
    ...
    public org.tempuri.Service1Soap getService1Soap12() throws javax.xml.rpc.ServiceException {
    ...
    public org.tempuri.Service1Soap getService1Soap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.tempuri.Service1Soap12Stub _stub = new org.tempuri.Service1Soap12Stub(portAddress, this);
    ...
    private java.lang.String Service1Soap_address = "http://10.10.1.80:4321/Service1.asmx";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.tempuri.Service1Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.tempuri.Service1Soap12Stub _stub = new org.tempuri.Service1Soap12Stub(new java.net.URL(Service1Soap12_address), this);
                _stub.setPortName(getService1Soap12WSDDServiceName());
                return _stub;
            }
            if (org.tempuri.Service1Soap.class.isAssignableFrom(serviceEndpointInterface)) {
