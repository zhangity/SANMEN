...
public class TODOQueryHistBean {
	...
	private String closetype = new String();				//允许为空，关闭方式
	private String closedate = new String();				//允许为空，关闭时间
	...
	public TODOQueryHistBean(String appcode) {
